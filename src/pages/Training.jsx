...
import { Dog as DogIcon, Moon, Hand, Megaphone, Handshake, Circle, Footprints, Hourglass, RotateCw, ChevronRight, Sparkles, Lock, PawPrint, Shield, Anchor, CloudRain } from "lucide-react";
...
const EXERCISES = [
  ...
  { order_number: 2,  name: "Couché",              icon: Moon,       iconColor: PALETTE.indigo, level: "debutant",      duration: "5 min",  is_premium: false, description: "Parfait pour les moments de calme et les lieux publics.", steps: ["Demande d'abord « Assis ».", "Place une friandise devant son museau puis descends-la vers le sol.", "Déplace-la lentement entre ses pattes.", "Dès qu'il se couche, dis « Couché » et récompense.", "Augmente progressivement la durée avant la récompense."] },
  { order_number: 3,  name: "Pas bouger",          icon: Hand,       iconColor: PALETTE.emerald, level: "debutant",      duration: "5 min",  is_premium: false, description: "Un ordre de sécurité crucial dans toutes les situations.", steps: ["Demande « Assis » ou « Couché ».", "Montre ta paume ouverte et dis « Pas bouger ».", "Fais un pas en arrière, reviens et récompense.", "Augmente progressivement la distance et la durée.", "Introduis des distractions pour solidifier l'ordre."] },
  { order_number: 4,  name: "Viens ici (Rappel)",  icon: Megaphone,  iconColor: PALETTE.red500, level: "debutant",      duration: "5 min",  is_premium: true,  description: "L'ordre le plus important pour la sécurité en extérieur.", steps: ["Commence en intérieur, à courte distance.", "Appelle son prénom + « Viens » avec enthousiasme.", "Récompense généreusement à chaque retour réussi.", "Augmente progressivement la distance.", "Pratique en laisse longue avant le rappel sans laisse."] },
  { order_number: 6,  name: "Lâche",               icon: Circle,     iconColor: PALETTE.emerald, level: "debutant",      duration: "5 min",  is_premium: true,  description: "Essentiel pour les jeux et la sécurité.", steps: ["Joue avec un jouet avec ton chien.", "Présente une friandise près de son museau.", "Quand il lâche, dis « Lâche » et donne la friandise.", "Rends le jouet immédiatement pour qu'il comprenne.", "Pratique régulièrement sans friandise ensuite."] },
  { order_number: 8,  name: "Attends",             icon: Hourglass,  iconColor: PALETTE.emerald, level: "intermediaire", duration: "5 min",  is_premium: true,  description: "Apprendre la patience avant une action.", steps: ["Demande « Assis » et dis « Attends ».", "Pose sa gamelle ou son jouet devant lui.", "Dis « Ok » ou « Vas-y » pour libérer.", "Augmente progressivement le temps d'attente.", "Pratique avant les repas, les jeux ou les sorties."] },
  { order_number: 5,  name: "Donne la patte",      icon: Handshake,  iconColor: PALETTE.emerald, level: "debutant",      duration: "3 min",  is_premium: true,  description: "Un tour sympathique qui renforce la complicité.", steps: ["Demande « Assis » à ton chien.", "Présente ta main paume vers le haut, légèrement inclinée.", "Quand il pose la patte, dis « Donne la patte » et récompense.", "Répète sans la friandise en utilisant uniquement le geste.", "Alterne les deux pattes pour l'équilibre."] },
  { order_number: 9,  name: "Tourne",              icon: RotateCw,   iconColor: PALETTE.indigo, level: "intermediaire", duration: "5 min",  is_premium: true,  description: "Un tour sur lui-même – pour stimuler et épater !", steps: ["Tiens une friandise devant le museau de ton chien.", "Trace lentement un cercle complet avec la friandise.", "Quand il complète le tour, récompense.", "Ajoute le signal verbal « Tourne ».", "Remplace ensuite la friandise par un geste de la main."] },
  { order_number: 10, name: "Touche",              icon: Hand,       iconColor: PALETTE.cautionAmber, level: "intermediaire", duration: "3 min",  is_premium: true,  description: "Toucher un objet ou une main sur commande.", steps: ["Présente ta main paume vers le chien.", "Quand il touche la paume avec son museau, dis « Touche » et récompense.", "Déplace ta main à différentes hauteurs et angles.", "Introduis d'autres surfaces à toucher.", "Utilise « Touche » pour guider ton chien vers des endroits précis."] },
  { order_number: 7,  name: "Au pied",             icon: Footprints, iconColor: PALETTE.blue, level: "intermediaire", duration: "10 min", is_premium: true,  description: "Promenades agréables sans tirer sur la laisse.", steps: ["Commence avec ton chien à ta gauche.", "Dès qu'il tire, arrête-toi complètement.", "Reprends quand la laisse se détend.", "Récompense fréquemment quand il marche bien.", "Progresse vers des environnements plus distractifs."] },
];
...
export default function Training() {
  ...
  return (
    ...
    >
      ...
      {/* Hero header */}
      <div className="gradient-primary safe-pt-14 mt-8 pb-0 px-5 overflow-hidden relative">
