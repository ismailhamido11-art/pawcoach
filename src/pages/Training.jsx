...
const EXERCISES = [
  { order_number: 1,  name: "Assis",               emoji: "🐶", icon: DogIcon,    iconColor: "#f59e0b", level: "debutant",      duration: "3 min",  is_premium: false, description: "La base de tout dressage – indispensable pour la sécurité.", steps: ["Tenez une friandise devant le museau de votre chien.", "Remontez lentement la friandise au-dessus de sa tête.", "Quand il s'assoit naturellement, dites « Assis » et donnez la friandise.", "Répétez 5 fois, puis réduisez progressivement la friandise.", "Pratiquez dans différents endroits et situations."] },
  { order_number: 2,  name: "Couché",              emoji: "🌙", icon: Moon,       iconColor: "#6366f1", level: "debutant",      duration: "5 min",  is_premium: false, description: "Parfait pour les moments de calme et les lieux publics.", steps: ["Demandez d'abord « Assis ».", "Placez une friandise devant son museau puis descendez-la vers le sol.", "Déplacez-la lentement entre ses pattes.", "Dès qu'il se couche, dites « Couché » et récompensez.", "Augmentez progressivement la durée avant la récompense."] },
  { order_number: 3,  name: "Pas bouger",          emoji: "✋", icon: Hand,       iconColor: "#f59e0b", level: "debutant",      duration: "5 min",  is_premium: false, description: "Un ordre de sécurité crucial dans toutes les situations.", steps: ["Demandez « Assis » ou « Couché ».", "Montrez votre paume ouverte et dites « Pas bouger ».", "Faites un pas en arrière, revenez et récompensez.", "Augmentez progressivement la distance et la durée.", "Introduisez des distractions pour solidifier l'ordre."] },
  { order_number: 4,  name: "Viens ici (Rappel)",  emoji: "📣", icon: Megaphone,  iconColor: "#ef4444", level: "debutant",      duration: "5 min",  is_premium: true,  description: "L'ordre le plus important pour la sécurité en extérieur.", steps: ["Commencez en intérieur, à courte distance.", "Appelez son prénom + « Viens » avec enthousiasme.", "Récompensez généreusement à chaque retour réussi.", "Augmentez progressivement la distance.", "Pratiquez en laisse longue avant le rappel sans laisse."] },
  ...
  { order_number: 8,  name: "Attends",             emoji: "⏳", icon: Hourglass,  iconColor: "#f59e0b", level: "intermediaire", duration: "5 min",  is_premium: true,  description: "Apprendre la patience avant une action.", steps: ["Demandez « Assis » et dites « Attends ».", "Posez sa gamelle ou son jouet devant lui.", "Dites « Ok » ou « Vas-y » pour libérer.", "Augmentez progressivement le temps d'attente.", "Pratiquez avant les repas, les jeux ou les sorties."] },
  { order_number: 5,  name: "Donne la patte",      emoji: "🤝", icon: Handshake,  iconColor: "#10b981", level: "debutant",      duration: "3 min",  is_premium: true,  description: "Un tour sympathique qui renforce la complicité.", steps: ["Demandez « Assis » à votre chien.", "Présentez votre main paume vers le haut, légèrement inclinée.", "Quand il pose la patte, dites « Donne la patte » et récompensez.", "Répétez sans la friandise en utilisant uniquement le geste.", "Alterner les deux pattes pour l'équilibre."] },
  { order_number: 9,  name: "Tourne",              emoji: "🔄", icon: RotateCw,   iconColor: "#6366f1", level: "intermediaire", duration: "5 min",  is_premium: true,  description: "Un tour sur lui-même – pour stimuler et épater !", steps: ["Tenez une friandise devant le museau de votre chien.", "Tracez lentement un cercle complet avec la friandise.", "Quand il complète le tour, récompensez.", "Ajoutez le signal verbal « Tourne ».", "Remplacez ensuite la friandise par un geste de la main."] },
  { order_number: 10, name: "Touche",              emoji: "👋", icon: Hand,       iconColor: "#f97316", level: "intermediaire", duration: "3 min",  is_premium: true,  description: "Toucher un objet ou une main sur commande.", steps: ["Présentez votre main paume vers le chien.", "Quand il touche la paume avec son museau, dites « Touche » et récompensez.", "Déplacez votre main à différentes hauteurs et angles.", "Introduisez d'autres surfaces à toucher.", "Utilisez « Touche » pour guider votre chien vers des endroits précis."] },
