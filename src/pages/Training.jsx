...
const EXERCISES = [
  { order_number: 1,  name: "Assis",               emoji: "🐶", icon: DogIcon,    iconColor: "#10b981", level: "debutant",      duration: "3 min",  is_premium: false, description: "La base de tout dressage – indispensable pour la securite.", steps: ["Tiens une friandise devant le museau de ton chien.", "Remonte lentement la friandise au-dessus de sa tete.", "Quand il s'assoit naturellement, dis « Assis » et donne la friandise.", "Repete 5 fois, puis reduis progressivement la friandise.", "Pratique dans differents endroits et situations."] },
  { order_number: 2,  name: "Couche",              emoji: "🌙", icon: Moon,       iconColor: "#6366f1", level: "debutant",      duration: "5 min",  is_premium: false, description: "Parfait pour les moments de calme et les lieux publics.", steps: ["Demande d'abord « Assis ».", "Place une friandise devant son museau puis descends-la vers le sol.", "Deplace-la lentement entre ses pattes.", "Des qu'il se couche, dis « Couche » et recompense.", "Augmente progressivement la duree avant la recompense."] },
  { order_number: 3,  name: "Pas bouger",          emoji: "✋", icon: Hand,       iconColor: "#10b981", level: "debutant",      duration: "5 min",  is_premium: false, description: "Un ordre de securite crucial dans toutes les situations.", steps: ["Demande « Assis » ou « Couche ».", "Montre ta paume ouverte et dis « Pas bouger ».", "Fais un pas en arriere, reviens et recompense.", "Augmente progressivement la distance et la duree.", "Introduis des distractions pour solidifier l'ordre."] },
  { order_number: 4,  name: "Viens ici (Rappel)",  emoji: "📣", icon: Megaphone,  iconColor: "#ef4444", level: "debutant",      duration: "5 min",  is_premium: true,  description: "L'ordre le plus important pour la securite en exterieur.", steps: ["Commence en interieur, a courte distance.", "Appelle son prenom + « Viens » avec enthousiasme.", "Recompense genereusement a chaque retour reussi.", "Augmente progressivement la distance.", "Pratique en laisse longue avant le rappel sans laisse."] },
  { order_number: 6,  name: "Lache",               emoji: "🎾", icon: Circle,     iconColor: "#10b981", level: "debutant",      duration: "5 min",  is_premium: true,  description: "Essentiel pour les jeux et la securite.", steps: ["Joue avec un jouet avec ton chien.", "Presente une friandise pres de son museau.", "Quand il lache, dis « Lache » et donne la friandise.", "Rends le jouet immediatement pour qu'il comprenne.", "Pratique regulierement sans friandise ensuite."] },
  { order_number: 8,  name: "Attends",             emoji: "⏳", icon: Hourglass,  iconColor: "#10b981", level: "intermediaire", duration: "5 min",  is_premium: true,  description: "Apprendre la patience avant une action.", steps: ["Demande « Assis » et dis « Attends ».", "Pose sa gamelle ou son jouet devant lui.", "Dis « Ok » ou « Vas-y » pour liberer.", "Augmente progressivement le temps d'attente.", "Pratique avant les repas, les jeux ou les sorties."] },
  { order_number: 5,  name: "Donne la patte",      emoji: "🤝", icon: Handshake,  iconColor: "#10b981", level: "debutant",      duration: "3 min",  is_premium: true,  description: "Un tour sympathique qui renforce la complicite.", steps: ["Demande « Assis » a ton chien.", "Presente ta main paume vers le haut, legerement inclinee.", "Quand il pose la patte, dis « Donne la patte » et recompense.", "Repete sans la friandise en utilisant uniquement le geste.", "Alterne les deux pattes pour l'equilibre."] },
  { order_number: 9,  name: "Tourne",              emoji: "🔄", icon: RotateCw,   iconColor: "#6366f1", level: "intermediaire", duration: "5 min",  is_premium: true,  description: "Un tour sur lui-meme – pour stimuler et epater !", steps: ["Tiens une friandise devant le museau de ton chien.", "Trace lentement un cercle complet avec la friandise.", "Quand il complete le tour, recompense.", "Ajoute le signal verbal « Tourne ».", "Remplace ensuite la friandise par un geste de la main."] },
  { order_number: 10, name: "Touche",              emoji: "👋", icon: Hand,       iconColor: "#d97706", level: "intermediaire", duration: "3 min",  is_premium: true,  description: "Toucher un objet ou une main sur commande.", steps: ["Presente ta main paume vers le chien.", "Quand il touche la paume avec son museau, dis « Touche » et recompense.", "Deplace ta main a differentes hauteurs et angles.", "Introduis d'autres surfaces a toucher.", "Utilise « Touche » pour guider ton chien vers des endroits precis."] },
  { order_number: 7,  name: "Au pied",             emoji: "🦮", icon: Footprints, iconColor: "#3b82f6", level: "intermediaire", duration: "10 min", is_premium: true,  description: "Promenades agreables sans tirer sur la laisse.", steps: ["Commence avec ton chien a ta gauche.", "Des qu'il tire, arrete-toi completement.", "Reprends quand la laisse se detend.", "Recompense frequemment quand il marche bien.", "Progresse vers des environnements plus distractifs."] },
];
