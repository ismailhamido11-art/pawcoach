  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="px-5 py-6 max-w-prose mx-auto space-y-6" style={{ paddingBottom: "env(safe-area-inset-bottom, 0px)" }}>
        ...
        <section className="space-y-2">
          <h2 className="text-base font-bold text-foreground">2. Description du service</h2>
          <p className="text-sm text-muted-foreground leading-relaxed">
        ...
        <section className="space-y-2">
          <h2 className="text-base font-bold text-foreground">3. Compte utilisateur</h2>
          <p className="text-sm text-muted-foreground leading-relaxed">
        ...
        <section className="space-y-2">
          <h2 className="text-base font-bold text-foreground">4. Abonnement Premium</h2>
          <p className="text-sm text-muted-foreground leading-relaxed">
        ...
        <section className="space-y-2">
          <h2 className="text-base font-bold text-foreground">6. Contenu généré par l'IA</h2>
          <p className="text-sm text-muted-foreground leading-relaxed">
        ...
        <section className="space-y-2">
          <h2 className="text-base font-bold text-foreground">7. Propriété intellectuelle</h2>
          <p className="text-sm text-muted-foreground leading-relaxed">
        ...
        <section className="space-y-2">
          <h2 className="text-base font-bold text-foreground">8. Limitation de responsabilité</h2>
          <p className="text-sm text-muted-foreground leading-relaxed">
        ...
        <section className="space-y-2">
          <h2 className="text-base font-bold text-foreground">9. Loi applicable</h2>
          <p className="text-sm text-muted-foreground leading-relaxed">
