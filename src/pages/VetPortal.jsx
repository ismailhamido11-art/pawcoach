      ...
      <div className="gradient-primary safe-pt-14 pb-8 px-5 relative overflow-hidden">
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-1">
            <Link to={createPageUrl("Home")} aria-label="Retour" className="w-11 h-11 rounded-xl bg-white/20 flex items-center justify-center hover:bg-white/30 transition-colors">
