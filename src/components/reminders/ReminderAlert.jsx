        ...
        <div className="bg-white border border-border rounded-2xl shadow-xl overflow-hidden mt-2">
          ...
          <div className="divide-y divide-border">
            {alerts.map((alert) => {
              ...
              return (
                <button key={alert.id} onClick={handleAlertClick} className="w-full flex items-center gap-3 px-4 py-2.5 text-left hover:bg-secondary/30 transition-colors">
