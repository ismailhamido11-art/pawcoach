...
const MOOD_OPTIONS = [
  ...
  { value: 4, Icon: Smile, color: "text-emerald-400", label: "Bien" },
  { value: 3, Icon: Meh, color: "text-amber-300", label: "Bof" },
  { value: 2, Icon: Frown, color: "text-slate-300", label: "Pas top" },
];
