...
import { RefreshCw, Check, ChevronDown, ChevronUp, Pencil, X, Trash2, Calendar, MessageCircle, Dog } from "lucide-react";
...
- Retourne UNIQUEMENT le JSON, rien d'autre`;
  ...
  // renderGenerator moved to ./MealPlanGenerator.jsx
  ...
  return (
    <div className="space-y-4 pb-4">
      ...
      <MealPlanGenerator
        ...
        onSavePlan={savePlan}
        onSetPlan={setPlan}
        onSetGenerationNotes={setGenerationNotes}
      />
