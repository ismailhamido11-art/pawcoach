...
// WALK_MOODS, WALK_TAGS, getWalkInsight moved to ./WalkSummary.jsx
      ...
      <AnimatePresence mode="wait">
        ...
        {status === "done" && (
          <WalkSummary
            ...
            moodSaved={moodSaved}
            showShare={showShare}
            onSaveMood={saveMoodData}
            onReset={handleReset}
            onSetShowShare={setShowShare}
            onSetWalkMood={setWalkMood}
            onSetSelectedMoodTags={setSelectedMoodTags}
