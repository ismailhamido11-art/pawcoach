...
Deno.serve(async (req) => {
  try {
    ...
    // Fetch vet visit records upfront (filtered by type — avoids loading all HealthRecords)
    ...
    // Build dog and user maps from upcoming vet visits only (targeted — avoids Dog.list/User.list)
